...
class CommentsResourceIT {
    ...
    private static final Long DEFAULT_FATHER = 1L;
    private static final Long UPDATED_FATHER = 2L;
    ...
    public static Comments createEntity(EntityManager em) {
        Comments comments = new Comments().text(DEFAULT_TEXT).father(DEFAULT_FATHER);
        return comments;
    }
    ...
    public static Comments createUpdatedEntity(EntityManager em) {
        Comments comments = new Comments().text(UPDATED_TEXT).father(UPDATED_FATHER);
        return comments;
    }
    ...
    void getAllComments() throws Exception {
        ...
        restCommentsMockMvc
            ...
            .andExpect(jsonPath("$.[*].father").value(hasItem(DEFAULT_FATHER.intValue())));
    }
    ...
    void getComments() throws Exception {
        ...
        restCommentsMockMvc
            ...
            .andExpect(jsonPath("$.father").value(DEFAULT_FATHER.intValue()));
    }
    ...
    void partialUpdateCommentsWithPatch() throws Exception {
        ...
        partialUpdatedComments.father(UPDATED_FATHER);
    ...
    void fullUpdateCommentsWithPatch() throws Exception {
        ...
        partialUpdatedComments.text(UPDATED_TEXT).father(UPDATED_FATHER);
